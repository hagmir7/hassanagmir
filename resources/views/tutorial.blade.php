...
<section class="relative py-8 sm:py-12 md:py-16 lg:py-20 overflow-hidden min-h-screen">
    ...
    <div class="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div class="text-center mb-8 sm:mb-12 md:mb-16 animate-pulse">
            ...
            <!-- Main Heading -->
            <h2
                class="text-2xl sm:text-3xl md:text-3xl lg:text-3xl xl:text-4xl font-bold text-white mb-4 sm:mb-6 leading-tight px-2">
                Start Your Coding
                <span
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 md:gap-8 max-w-7xl mx-auto">
                ...
                <div class="relative z-10">
                    <div
                        ...
                        <img class="w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 lg:w-28 lg:h-28 object-contain"
                            src="https://upload.wikimedia.org/wikipedia/commons/thumb/c/c3/Python-logo-notext.svg/225px-Python-logo-notext.svg.png"
                            alt="Python Logo" loading="lazy">
                    </div>
                    <h3
                        class="text-xl sm:text-2xl md:text-3xl font-bold text-white mb-2 sm:mb-4 transition-colors text-center">
                        Python</h3>
                    <p
                        class="text-gray-400 mb-2 sm:mb-4 leading-relaxed text-center text-sm sm:text-base md:text-lg lg:text-xl">
            ...
            <!-- JavaScript Card -->
            <div
                class="group bg-slate-800 rounded-xl sm:rounded-2xl p-4 sm:p-6 shadow-md hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-1 sm:hover:-translate-y-2 border border-slate-700 relative overflow-hidden sm:col-span-2 lg:col-span-1">
                <div
                    class="absolute inset-0 bg-gradient-to-br from-blue-50/50 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500">
                </div>
                <div class="relative z-10">
                    <div
                        class="w-full rounded-xl sm:rounded-2xl flex items-center justify-center mb-4 sm:mb-6 group-hover:scale-105 sm:group-hover:scale-110 transition-transform duration-300">
                        <img class="w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 lg:w-28 lg:h-28 object-contain"
                            src="https://skillforge.com/wp-content/uploads/2020/10/javascript-1817x2048.png"
                            alt="JavaScript Logo" loading="lazy">
                    </div>
                    <h3
                        class="text-xl sm:text-2xl md:text-3xl font-bold text-white mb-2 sm:mb-4 transition-colors text-center">
                        JavaScript</h3>
