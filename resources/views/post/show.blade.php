...
@section('content')
    <div class="mx-auto max-w-screen-lg px-3 py-6">
        ...
        <div class="mx-auto mt-5 max-w-prose">
            ...
            <div class="prose mt-8 space-y-0 prose-h2:text-white prose-h3:text-white prose-img:rounded-lg text-left prose-strong:text-gray-200 text-gray-300 prose-a:text-white">
                {!! $post->content !!}
            </div>
        </div>
    </div>
